...
# https://www.youtube.com/watch?v=IN6FotfaihQ
...
def randomized_quick_sort(a, left, right):
    ...
    #use partition3
    middle1, middle2 = partition3(a, left, right)
    randomized_quick_sort(a, left, middle1 - 1);
    randomized_quick_sort(a, middle2 + 1, right);
